...
export const debouncedTooltipPlacement = ref<Placement>('top')

export const hoveredElement = ref<Maybe<HTMLElement>>()
export const debouncedHoveredElement = ref<Maybe<HTMLElement>>()

const contentMap = new Map<string, Content>()
export const getContent = (key: string) => contentMap.get(key)
export const setContent = (key: string, value: Content) =>
  contentMap.set(key, value)
export const deleteContent = (key: string) => contentMap.delete(key)
